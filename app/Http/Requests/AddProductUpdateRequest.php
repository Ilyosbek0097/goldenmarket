...
class AddProductUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'body_price_usd' => 'required|numeric|min:0|max:9999999999999999.99',
            'body_price_uzs' => 'required|numeric|min:0|max:9999999999999999.99',
            'sales_price' => 'required|numeric|min:0|max:9999999999999999.99',
