                                                ...
                                                @foreach($brandAll as $brand)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a class="btn btn-info btn-sm" href=" {{ route('brands.edit', $brand->brand_id) }}"><i class="bx bx-edit-alt me-1"></i> Tahrirlash</a>
                                                            <button data-id="{{ $brand->brand_id }}" type="button" class="btn btn-danger btn-sm btnDelete" data-bs-toggle="modal" data-bs-target="#modalTop" ><i class="bx bx-trash me-1"></i> O'chirish</button>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
