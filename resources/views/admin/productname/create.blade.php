...
@section('title', 'Product Name Create')
@section('content')
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Maxsulot To'liq Nomini Yaratish</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('productnames.store') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="old_code" class="form-control @error('old_code') is-invalid @enderror" id="old_code">
                                @error('old_code')
                                    <div class="mt-2 text-danger">
                                        {{ $message }}
                                    </div>
