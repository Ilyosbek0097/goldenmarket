        ...
        <div class="col-lg-12 mb-4 order-0">
            ...
            <div class="card">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('types.update', $typeOne->type_id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                                <label class="form-label" for="type_name">Tur Nomi</label>
                                <input type="text" value="{{ $typeOne->type_name }}" id="type_name" class="form-control @error('type_name') is-invalid @enderror" name="type_name"  placeholder="Tur Nomini Kiriting...">
                                @error('type_name')
